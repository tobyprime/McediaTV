...
public final class MtvWorldUiRenderer {
    ...
    private static void drawScreen(VertexConsumer vertex, MultiBufferSource bufferSource, PoseStack.Pose pose, Vec3 camera, EntityPlayerHandle.WorldUiScreen screen) {
        ...
        if (!PRESENTATION.isExpanded(target)) {
            ...
            quad(vertex, pose, camera, screen.plane(), 0.93F, 0.93F, 0.99F, 0.99F, fadeColor(0xD9242828, fade));
            quad(vertex, pose, camera, screen.plane(), 0.955F, 0.945F, 0.975F, 0.975F, fadeColor(0xFFF0F0F0, fade));
            drawText(pose, bufferSource, camera, screen.plane(), "+", 0.958F, 0.954F, 0.0014F, fadeColor(0xFFFFFFFF, fade));
            return;
        }
