...
public final class MtvAddMediaScreen extends Screen {
    ...
    private MtvAddMediaScreen(WorldUiInteractionState.Target target) { super(Component.literal("MTV / Add media")); this.target = target; this.model = new WorldUiAddMediaModel(top.tobyprime.mcedia_mtv.client.metadata.MtvMediaMetadataCache.getInstance()); }
